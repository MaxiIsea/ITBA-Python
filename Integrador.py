# NOTA: Esto lo pongo en un bloque separado porque seria comun a todo el programa.
# Las distintas partes "1", "2", etc. Se podrian modularizar y llamarlas en un Menu.
...
aux = df_archivo.to_dict("list") # dict, list, series, split, records, index
