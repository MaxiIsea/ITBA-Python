...
def menu_opcion_1():
  ...
  print("¿Desea almacenar el gráfico generado? (s/n)")
  if pedirSiNo() == "S": 
...
def menu_opcion_5():
  ...
  print()
  print("Nota adicional: Todas las opciones de la aplicación permitirán al usuario guardar una imagen del grafico generado en formato PNG. Se solicitará al usuario el nombre del archivo en cuestión.")
  print()
  print("Presione cualquier tecla para salir de la ayuda...")
  msvcrt.getch()
...
while not salir:
    ...
    print("*******************************************************")
    print()
    print("1. Graficar estadisticas de un pais a elección")
